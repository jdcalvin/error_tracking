...
class ValidationsControllerTest < ActionController::TestCase
  ...
  test "should create validation" do
    assert_difference('Validation.count') do
      post :create, validation: { approval: @validation.approval, order_id: @validation.order_id, task_id: @validation.task_id }
    end
  ...
  test "should update validation" do
    patch :update, id: @validation, validation: { approval: @validation.approval, order_id: @validation.order_id, task_id: @validation.task_id }
    assert_redirected_to validation_path(assigns(:validation))
  end
